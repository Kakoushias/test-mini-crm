...
test('controller fetches paginated data', function () {
    ...
    //seed clients and authenticate administrator
...
test('controller stores new client', function () {
    ...
    auth()->login(User::whereName('administrator')->firstOrFail());
...
//test('controller update validation fails when it should', function (){
//    //authenticate administrator
//    auth()->login(User::whereName('administrator')->firstOrFail());
//
//    $client = Client::factory()->create();
//    //create fake file, smaller dimensions than required
//    $file = UploadedFile::fake()->image('avatar3.jpg', 50, 50);
//
//    //call api to update client, assert validation fail
//    $response = $this->getJson(route('clients.edit', [
//        'client' => $client->id,
//    ]), [
...
//
//    //repeat the test with file with valid dimensions but wrong email format
//    $file = UploadedFile::fake()->image('avatar4.jpg', 150, 150);
//
//    //call api to update client, assert validation fail
//    $response = $this->getJson(route('clients.edit', [
//        'client' => $client->id,
